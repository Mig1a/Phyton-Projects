import pandas as pd
## Loading the data -----------
df = pd.read_csv("CrimeReports (1).csv")
...
new_count.to_excel("Most_reported_Crimetype_in_city.xlsx",
                       index=True)
...
freq.to_excel("Freq_incident.xlsx",
                  index=True)
...
trend.to_excel("time_trend.xlsx",index=True)
